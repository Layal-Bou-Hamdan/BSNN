...
class BayesDiagSheafDiffusion(SheafDiffusion):
    ...
    def __init__(self, edge_index, args):
        ...
        self.sheaf_use_deg = args.get("sheaf_use_deg", False)
        assert args['d'] > 0
...
class BayesBundleSheafDiffusion(SheafDiffusion):
    ...
    def __init__(self, edge_index, args):
        ...
        self.sheaf_use_deg = args.get("sheaf_use_deg", False)  # ✅ Add this
...
class BayesGeneralSheafDiffusion(SheafDiffusion):
    ...
    def __init__(self, edge_index, args):
        ...
        self.sheaf_use_deg = args.get("sheaf_use_deg", False)  # ✅ Add this line
